! function(e) {
    ...
    r.cleanData = (n = r.cleanData, function(e) {
        ...
        var s, n, a, o = {},
            h = e.split(".")[0],
            l = h + "-" + (e = e.split(".")[1]);
        return t || (t = i, i = r.Widget), r.isArray(t) && (t = r.extend.apply(null, [{}].concat(t))), r.expr[":"][l.toLowerCase()] = function(e) {
            return !!r.data(e, l)
            ...
            _proto: r.extend({}, t),
            _childConstructors: []
        }), (a = new i).options = r.widget.extend({}, a.options), r.each(t, function(t, s) {
            function n() {
        ...
        for (var t, i, s = h.call(arguments, 1), n = 0, a = s.length; n < a; n++)
            for (t in s[n]) i = s[n][t], s[n].hasOwnProperty(t) && void 0 !== i && (r.isPlainObject(i) ? e[t] = r.isPlainObject(e[t]) ? r.widget.extend({}, e[t], i) : r.widget.extend({}, i) : e[t] = i);
        return e
        ...
        option: function(e, t) {
            ...
            if ("string" == typeof e)
                if (a = {}, e = (i = e.split(".")).shift(), i.length) {
                    for (s = a[e] = r.widget.extend({}, this.options[e]), n = 0; n < i.length - 1; n++) s[i[n]] = s[i[n]] || {}, s = s[i[n]];
        ...
        _classes: function(n) {
            ...
            function e(e, t) {
                for (var i, s = 0; s < e.length; s++) i = o.classesElementLookup[e[s]] || r(), i = n.add ? r(r.unique(i.get().concat(n.element.get()))) : r(i.not(n.element).get()), o.classesElementLookup[e[s]] = i, a.push(e[s]), t && n.classes[e[s]] && a.push(n.classes[e[s]])
            }
            return n = r.extend({
        ...
        _on: function(n, a, e) {
            var o, h = this;
            "boolean" != typeof n && (e = a, a = n, n = !1), e ? (a = o = r(a), this.bindings = this.bindings.add(a)) : (e = a, a = this.element, o = this.widget()), r.each(e, function(e, t) {
                function i() {
                    if (n || !0 !== h.options.disabled && !r(this).hasClass("ui-state-disabled")) return ("string" == typeof t ? h[t] : t).apply(h, arguments)
                }
                "string" != typeof t && (i.guid = t.guid = t.guid || i.guid || r.guid++);
                var s;
                e = (s = e.match(/^([\w:-]*)\s*(.*)$/))[1] + h.eventNamespace;
        ...
        r.Widget.prototype["_" + a] = function(t, e, i) {
            ...
            var n = e ? !0 !== e && "number" != typeof e && e.effect || o : a;
            "number" == typeof(e = e || {}) && (e = {
                duration: e
    ...
    r(document).on("mouseup", function() {
        ...
        _mouseDown: function(e) {
            if (!a) {
                ...
                return !(i && !s && this._mouseCapture(e)) || (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout(function() {
                    ...
                    return t._mouseUp(e)
                }, this.document.on("mousemove." + this.widgetName, this._mouseMoveDelegate).on("mouseup." + this.widgetName, this._mouseUpDelegate), e.preventDefault(), a = !0))
            }
        },
        ...
        _createHandles: function() {
            ...
            this.handles = i.add(r(s.join("")).appendTo(this.element)), this._addClass(this.handles, "ui-slider-handle", "ui-state-default"), this.handle = this.handles.eq(0), this.handles.each(function(e) {
        ...
        _mouseCapture: function(e) {
            ...
            return !l.disabled && (this.elementSize = {
                ...
                (t < s || s === t && (e === h._lastChangedValue || h.values(e) === l.min)) && (s = t, n = r(this), a = e)
            }), !1 !== this._start(e, a) && (this._mouseSliding = !0, this._handleIndex = a, this._addClass(n, null, "ui-state-active"), n.trigger("focus"), t = n.offset(), o = !r(e.target).parents().addBack().is(".ui-slider-handle"), this._clickOffset = o ? {
                left: 0,
                top: 0
            } : {
        ...
        _refreshValue: function() {
            ...
            this._hasMultipleValues() ? this.handles.each(function(e) {
                i = (h.values(e) - h._valueMin()) / (h._valueMax() - h._valueMin()) * 100, u["horizontal" === h.orientation ? "left" : "bottom"] = i + "%", r(this).stop(1, 1)[l ? "animate" : "css"](u, o.animate), !0 === h.options.range && ("horizontal" === h.orientation ? (0 === e && h.range.stop(1, 1)[l ? "animate" : "css"]({
                    left: i + "%"
                }, o.animate), 1 === e && h.range[l ? "animate" : "css"]({
                    width: i - t + "%"
                }, {
                    queue: !1,
                    duration: o.animate
                })) : (0 === e && h.range.stop(1, 1)[l ? "animate" : "css"]({
                    bottom: i + "%"
                }, o.animate), 1 === e && h.range[l ? "animate" : "css"]({
                    height: i - t + "%"
                }, {
            ...
            }) : (e = this.value(), s = this._valueMin(), n = this._valueMax(), i = n !== s ? (e - s) / (n - s) * 100 : 0, u["horizontal" === this.orientation ? "left" : "bottom"] = i + "%", this.handle.stop(1, 1)[l ? "animate" : "css"](u, o.animate), "min" === a && "horizontal" === this.orientation && this.range.stop(1, 1)[l ? "animate" : "css"]({
                width: i + "%"
